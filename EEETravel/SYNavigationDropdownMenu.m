...
- (void)updateMenuBackground {
    ...
    CGFloat tmpHeight =  menuBackgroundViewFrame.size.height - CGRectGetMaxY(self.navigationController.navigationBar.frame);
    CGFloat height = MIN(tmpHeight,_maxHeight);
    menuBackgroundViewFrame.size.height = height;
